...
class HardFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        val currentstreak = view.findViewById<TextView>(R.id.CurentStreakHard)
        val beststreak = view.findViewById<TextView>(R.id.BestStreakHard)
        val avrtime = view.findViewById<TextView>(R.id.AvrTimeHard)
        val besttime = view.findViewById<TextView>(R.id.BestTimeHard)
        val gamestarted = view.findViewById<TextView>(R.id.GameStartedHard)
        val gamewon = view.findViewById<TextView>(R.id.GameWonHard)
        val winrate = view.findViewById<TextView>(R.id.WinRateHard)
        ...
        activity?.let {
            ...
            sharedViewModel.inputString.observe(this, Observer {
                Result(it,"Hard",beststreak,currentstreak,gamestarted,gamewon,winrate)
    ...
    private fun GameWon(id: String, level: String, tv1: TextView,tv2: TextView,i :Int) {
        ...
        val eventListener: ValueEventListener = object : ValueEventListener {
            override fun onDataChange(dataSnapshot: DataSnapshot) {
                ...
                tv1.setText(ListGame.size.toString())
                if(i!=0){
                    var winrate = (ListGame.size * 100.00 / i )
        ...
        val eventListener: ValueEventListener = object : ValueEventListener {
            override fun onDataChange(dataSnapshot: DataSnapshot) {
                for (ds in dataSnapshot.children) {
                    ...
                    //Lọc ra danh sách theo từng cấp độ chơi vào mảng items
                    val f = Pattern.compile("Hard")//chuỗi cần tìm
