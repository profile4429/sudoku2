...
import com.example.sudoku.Fragment.EasyFragment.Companion.newInstance
...
//        viewEasy.Result(id,"Easy")
    ...
    private fun setupTabs(){
        ...
        adapter.addFragment(EasyFragment.newInstance(
            intent.getStringExtra("id1"),
            intent.getStringExtra("id2")
        ),"Easy")
        adapter.addFragment(NormalFragment.newInstance(
            intent.getStringExtra("id1"),
            intent.getStringExtra("id2")
        ),"Normal")
        adapter.addFragment(HardFragment.newInstance(
            intent.getStringExtra("id1"),
            intent.getStringExtra("id2")
        ),"Hard")
